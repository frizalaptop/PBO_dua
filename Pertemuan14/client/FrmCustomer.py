...
class FrmCustomer:
    ...
    def aturKomponen(self):
        mainFrame = ttk.Frame(self.parent, padding=10)
        mainFrame.pack(fill=BOTH, expand=YES)
        
        # Label
        ttk.Label(mainFrame, text='KTP:').grid(row=0, column=0,
            sticky=W, padx=5, pady=5)
        ttk.Label(mainFrame, text='Nama:').grid(row=1, column=0,
            sticky=W, padx=5, pady=5)
        ttk.Label(mainFrame, text='Jenis Kelamin:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        ttk.Label(mainFrame, text='Kota:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        
        # Textbox
        self.txtKtp = ttk.Entry(mainFrame) 
        ...
        self.txtKota = ttk.Entry(mainFrame) 
